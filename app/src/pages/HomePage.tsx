...
export const HomePage = (): React.ReactElement => {
  ...
  const onScrolled = React.useCallback((): void => {
    ...
    console.log('scrollingRef.current.scrollHeight', scrollingRef.current.scrollHeight);
    console.log('scrollingRef.current.clientHeight', scrollingRef.current.clientHeight);
          ...
          <Stack direction={Direction.Horizontal} shouldAddGutters={true} isFullHeight={true} isFullWidth={true}>
            <ResponsiveHidingView hiddenBelow={ScreenSize.Medium}>
              <Box width='300px' isFullHeight={true}>
                <Stack direction={Direction.Vertical} isFullHeight={true} isScrollableVertically={true} contentAlignment={Alignment.Start} shouldAddGutters={true} paddingRight={PaddingSize.Default} paddingLeft={PaddingSize.Wide2}>
            ...
            <Stack.Item growthFactor={1} shrinkFactor={1}>
              <Stack direction={Direction.Vertical} shouldAddGutters={true} isScrollableVertically={true} contentAlignment={Alignment.Start} paddingRight={PaddingSize.Wide2}>
                ...
                {/* <Box ref={scrollingRef} isScrollableVertically={true}> */}
                <Stack.Item>
